...
/*   Updated: 2025/03/02 14:48:46 by mafourni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	everything(t_tokens *token_clean, t_command cmd, t_garbage **gc,
...
// int	main(int argc, char **argv, char **envp) Ancienne version
// {
// 	t_tokens	*token_clean;
// 	char		*input;
// 	t_env		*env;
